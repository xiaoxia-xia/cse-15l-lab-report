...
![combineThem](images/Week2/combineThose.png)
    I use the code line as ``scp WhereAmI.java ieng6:~``and ``ssh ieng6 "javac WhereAmI.java; java WhereAmI"`` to have WheveAmI running in remove server. To total time of running them is 54 seconds.
